...
const diffAdvanced = document.querySelector("#normal");
const diffHard = document.querySelector("#mittel");
const diffExtreme = document.querySelector("#schwer");
...
Sound1.addEventListener('click', (event) => {
  if (on) {
    playerOrder.push(1);
    check();
    one();
...
Sound2.addEventListener('click', (event) => {
  if (on) {
    playerOrder.push(2);
    check();
    two();
...
Sound3.addEventListener('click', (event) => {
  if (on) {
    playerOrder.push(3);
    check();
    three();
...
Sound4.addEventListener('click', (event) => {
  if (on) {
    playerOrder.push(4);
    check();
    four();
...
Sound5.addEventListener('click', (event) => {
    if (on) {
      playerOrder.push(4);
      check();
      four();
